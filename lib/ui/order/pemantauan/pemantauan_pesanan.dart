...
class _OrderTrackingPageState extends State<OrderTrackingPage> {
  ...
  List<OrderItemTopping>? _cachedItems;
            ...
            return ListView(
              ...
              children: [
                ...
                _buildTimelineTile(
                  ...
                  timestamp: statusIndex == 0 ? order.createdAt : '',
                  isFirst: true,
                ),
                _buildTimelineTile(
                  index: 1,
                  ...
                  statusIndex: statusIndex,
                  timestamp: statusIndex == 1 ? order.updateAt : '',
                ),
                _buildTimelineTile(
                  index: 2,
                  icon: Icons.outdoor_grill_outlined,
                  title: 'Pesanan Diproses',
                  description: 'Koki menyiapkan pesanan.',
                  statusIndex: statusIndex,
                  timestamp: statusIndex == 2 ? order.updateAt : '',
                ),
                _buildTimelineTile(
                  index: 3,
                  ...
                  statusIndex: statusIndex,
                  timestamp: statusIndex == 3 ? order.updateAt : '',
                  extra: statusIndex == 3
                      ? _buildQrButton(order.order_number)
                      : null,
                ),
                _buildTimelineTile(
                  index: 4,
                  ...
                  statusIndex: statusIndex,
                  timestamp: statusIndex == 4 ? order.updateAt : '',
                  isLast: true,
                ),
              ],
            );
  ...
  Widget _buildMenuItemCard(OrderItemTopping item) {
    return Container(
      ...
      child: SizedBox(
        ...
        child: ElevatedButton.icon(
          ...
          onPressed: () => Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => OrderQrPage(orderNumber: orderNumber),
            ),
          ),
        ),
      ),
